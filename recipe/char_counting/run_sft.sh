...
TRAIN_FILES=${TRAIN_FILES:-./data/char_count/sft/train.parquet}
TEST_FILES=${TEST_FILES:-./data/char_count/sft/test.parquet}
...
CKPT_HOME=${CKPT_HOME:-./experiments/char_count/models/sft/$backend}
mkdir -p "${CKPT_HOME}"
